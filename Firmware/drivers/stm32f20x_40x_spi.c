...
int stm32_hw_spi_init(void)
{
	...
	stm32_spi_cs_mpu6500.GPIOx = GPIOA;
	stm32_spi_cs_mpu6500.GPIO_Pin = GPIO_Pin_4;
	...
	rt_spi_bus_attach_device(&rt_spi_device_mpu6500, "mpu6500", "spi1", (void*)&stm32_spi_cs_mpu6500);
	
	/*init ms5611 spi bus*/
	//RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE);

	stm32_spi_cs_ms5611.GPIOx = GPIOD;
	stm32_spi_cs_ms5611.GPIO_Pin = GPIO_Pin_2;
