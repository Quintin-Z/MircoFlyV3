...
class MPU9250 :public SensorBase
{
public:
	MPU9250(int sensor_type, const char* spi_bus);
...
class MPU9250_Accelerometer:public MPU9250
{
public:
    MPU9250_Accelerometer(const char* spi_name);
...
class MPU9250_Magnetometer:public MPU9250
{
public:
    MPU9250_Magnetometer(const char* spi_name);
