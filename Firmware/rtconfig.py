...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + ' -nostartfiles -Wl,--gc-sections,-Map=mfv3-frmware.map,-cref,-u,Reset_Handler -T stm32_rom.ld'
    ...
    POST_ACTION = OBJCPY + ' -O binary $TARGET mfv3-frmware.bin\n' + SIZE + ' $TARGET \n'
